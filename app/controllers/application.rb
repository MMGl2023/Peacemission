...
class ApplicationController < ActionController::Base
  ...
  around_filter :set_comments_visibility


  TzTime.zone = TZInfo::Timezone.new('Europe/Moscow')
  ...
  def set_comments_visibility
    ...
    Comment.send(:with_scope, :find => {:conditions => cnds}) do
      yield
    end  
  end
  ...
  def can_edit_comment?(c=nil)
    (cc = c || @comment) && (
      ...
      cc.session_id == session.session_id || has_permission?(:comments)
    )
  end
